...
public class WebDriverScope {
	public static void main(String[] args) {
		...
		WebElement  webElement=driver.findElement(By.xpath("//div[@aria-labelledby='mainIndexInterlinkingTab-1-tab-trigger']"));
    	...
    	driverWait.until(ExpectedConditions.elementToBeClickable(By.xpath("//div[@aria-labelledby='mainIndexInterlinkingTab-1-tab-trigger']//a")));
